...
void InitInfo()
{
    ...
    infoDescriptions[0x05] = "X[OP]=1..4,5; Y=0..3; 0X or --: RESET";
    infoDescriptions[0x06] = "X[OP]=1..4,5; Y=0..F; 0X or --: RESET";
    infoDescriptions[0x07] = "X[OP]=1..4,5; Y=0..7; 0X or --: RESET";
    infoDescriptions[0x08] = "X[OP]=1..4,5; Y=0..1; 0X or --: RESET";
    infoDescriptions[0x09] = "X[OP]=1..4,5; Y=0..8; 0X or --: RESET";
    ...
    infoDescriptions[0x11] = "Any value DAC ON, --: DAC OFF        ";
    ...
    infoDescriptions[0x34] = "--: RESET [Default 8]                ";
