...
namespace mdteditor
{
    ...
    {
        private int ROM_SAMPLE_BANK = 0x00040f00; // sample_bank_1; check symbol.txt when md.tracker code is changed
        
        //private const int ROM_SAMPLE_BANK_SIZE = 3399000 - ROM_SAMPLE_NAMES_SIZE;
        private const int ROM_SAMPLE_BANK_SIZE = 00330400; // sample_bank_1_size
